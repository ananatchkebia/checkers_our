            ...
            if(pygame.mouse.get_pressed()[0]):
                ...
                if(movement_done):          
                    ...
                    for way in list_for_possible_moves:
                        ...
                        if(board.board[way[0][0]][way[0][1]].piece != None):
                            pygame.draw.rect(WIN,BLACK,(way[0][1]*SQUARE_SIZE,way[0][0]*SQUARE_SIZE,SQUARE_SIZE,SQUARE_SIZE))
                            pygame.draw.circle(WIN,GREY,((way[0][1]* SQUARE_SIZE) + SQUARE_SIZE //2 ,(way[0][0]* SQUARE_SIZE) + SQUARE_SIZE//2), SQUARE_SIZE//2 -8)
                            pygame.draw.circle(WIN,board.board[way[0][0]][way[0][1]].piece.color,((way[0][1]* SQUARE_SIZE) + SQUARE_SIZE //2 ,(way[0][0]* SQUARE_SIZE) + SQUARE_SIZE//2), SQUARE_SIZE//2 -10)
